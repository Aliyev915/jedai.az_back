...
<div class="page">
   <div class="page-header">
      <h1 class="page-title">Paket Kateqoriyaları</h1>
   </div>
...
<script>
   $(function() {
      ...
      $('.edit-click').click(function(){
         ...
         $.ajax({
            type:'GET',
            url:'/admin/packages/p-category/'+id+'/edit',
            success:function(data){
               console.log(data);    
               $("#editForm").attr({action: '/admin/packages/p-category/'+id});
               $('#lang').val(data.lang);   
      ...
      $('.status').change(function() {
         ...
         $.get("{{route('admin.p-category.status')}}",{id:id,status:status}, function(data, status){
         console.log(data);
         });
      });
      ...
      $('.delete-click').click(function() {
         id = $(this)[0].getAttribute('data-id');
         $("#deleteForm").attr({action: '/admin/packages/p-category/'+id});
...
<div class="modal fade" id="exampleFormModal" aria-hidden="false" aria-labelledby="exampleFormModalLabel"
   ...
   <div class="modal-dialog modal-simple">
      <form  method="POST" action="{{ route('p-category.store')}}" class="modal-content" enctype="multipart/form-data">
         @csrf
         ...
         <div class="modal-body">
            <div class="row">
               <div class="col-xl-12 form-group">
                  <input type="text" class="form-control" name="title" id="title" placeholder="Başlıq Əlavə Et" required="required" />
               </div>
               <div class="col-xl-12 form-group">
                  <input type="number" class="form-control" name="sort" id="sort" placeholder="Sıra Əlavə Et" required="required" />
               </div>
