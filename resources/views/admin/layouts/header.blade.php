<!DOCTYPE html>
<html class="no-js css-menubar" lang="{{App::currentLocale()}}">
 <head>
      <meta charset="utf-8">
      ...
      <title>Jedai.az  | Admin Panel</title>
      ...
      <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-expand-md"
         ...
         <div class="navbar-header">
            ...
            <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
               ...
               <span class="navbar-brand-text hidden-xs-down"> Jedai.az</span>
            </div>
         </div>
            ...
            <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
               ...
               <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
                  <li class="nav-item dropdown">
                     @if(App::isLocale('az'))
                     <a class="nav-link" data-toggle="dropdown" href="{{ url('/adminlocale/az') }}" data-animation="scale-up"
                     aria-expanded="false" role="button">
                     <span class="flag-icon flag-icon-az"></span>
                     @elseif(App::isLocale('en'))
                     <a class="nav-link" data-toggle="dropdown" href="{{ url('/adminlocale/en') }}" data-animation="scale-up"
                     aria-expanded="false" role="button">
                     <span class="flag-icon flag-icon-gb"></span>
                     @elseif(App::isLocale('ru'))
                     <a class="nav-link" data-toggle="dropdown" href="{{ url('/adminlocale/ru') }}" data-animation="scale-up"
                     aria-expanded="false" role="button">
                     ...
                     <div class="dropdown-menu" role="menu">
                        ...
                        <a class="dropdown-item" href="{{ url('/adminlocale/az') }}" role="menuitem">
                          <span class="flag-icon flag-icon-az"></span> Azərbaycan</a>
                   
               
                       <a class="dropdown-item" href="{{ url('/adminlocale/en') }}" role="menuitem">
                         <span class="flag-icon flag-icon-gb"></span> English</a>
              
               
                       <a class="dropdown-item" href="{{ url('/adminlocale/ru') }}" role="menuitem">
                  ...
                  <li class="nav-item dropdown">
                     ...
                     <div class="dropdown-menu" role="menu">
                        <a class="dropdown-item" href="{{route('admin.profil')}}" role="menuitem"><i class="icon wb-user" aria-hidden="true"></i> Profile</a>
                        <a class="dropdown-item" href="{{route('admin.setting.general')}}" role="menuitem"><i class="icon wb-settings" aria-hidden="true"></i> Settings</a>
                 ...
                 <li class="nav-item dropdown">
                     <a class="nav-link"  href="#" title="Bildirişlər">
                     <i class="icon fa-comment" aria-hidden="true"></i>
                      <span class="badge badge-pill badge-danger up"></span>
                     </a>
                  </li>
 
                  <li class="nav-item dropdown">
                     <a class="nav-link"  href="#" title="Mesajlar">
                     <i class="icon wb-envelope" aria-hidden="true"></i>
                     <span class="badge badge-pill badge-info up">2</span>
                     </a>
                  </li>
