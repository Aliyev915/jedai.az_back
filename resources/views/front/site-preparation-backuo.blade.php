...
<script>
   ...
   window.addEventListener('scroll', function() {
      ...
      if (window.innerWidth > 600) {
         ...
         if (portfolio.top < 200 && portfolio.bottom < 4100 && portfolio.top > -3000 && portfolio.bottom > 920 ) {
      ...
      if (window.innerWidth < 600) {
         if (prices.top < 158.25 && prices.bottom < 7359.875 && prices.top > -6486.75 && prices.bottom > 526.875 ) {
            document.querySelector('.quicklinksImg1').setAttribute('style' , 'filter:grayscale(0);')
            document.querySelector('.quicklinksTitle1').setAttribute('style' , 'color:#225A93;')
         }
         else 
         ...
         if (komanda.top < 163.875 && komanda.bottom < 4181.375 && komanda.top > -3170.125 && komanda.bottom > 681.375 ) {
            document.querySelector('.quicklinksImg2').setAttribute('style' , 'filter:grayscale(0);')
            document.querySelector('.quicklinksTitle2').setAttribute('style' , 'color:#225A93;')
         }
         else 
         ...
         if (portfolio.top < 200 && portfolio.bottom < 7669.375 && portfolio.top > -6666.625 && portfolio.bottom > 835 ) {
            document.querySelector('.quicklinksImg4').setAttribute('style' , 'filter:grayscale(0);')
            document.querySelector('.quicklinksTitle4').setAttribute('style' , 'color:#225A93;')
         }
         else 
         ...
         if (aboutus.top < 200 && aboutus.bottom < 7669.375 && aboutus.top > -6666.625 && aboutus.bottom > 835 ) {
            document.querySelector('.quicklinksImg5').setAttribute('style' , 'filter:grayscale(0);')
            document.querySelector('.quicklinksTitle5').setAttribute('style' , 'color:#225A93;')
         }
         else 
   ...
   <div class="buttonContWPAnd">
      <a href="https://wa.me/994709836699" target="new_blank"><button class="buttonForWP"><img src="/assets/images/wpIcon.png" alt="" width="45" height="auto" style="margin-top:1.5px;"></button></a>
      <a href="tel:+994709836699" target="new_blank"><button class="buttonForTelegram"><img src="/assets/images/phone.svg" alt="" width="30" height="auto" style="margin-top:1.5px;"></button></a>
      <button class="buttonForScroll" id="scrollToTop" onclick="topFunction()" title="Go to top"><img src="/assets/images/arrow.svg" alt="" width="30"></button>
   </div>
   <div class="topContainer" id="topContainer">
      ...
      <div class="subNav">
         ...
         <p class="subTitle">@lang('lang.muasir_fremwork1')</p>
         <p class="subTitle">@lang('lang.muasir_fremwork2')</p>
         
      </div>
      <div class="subTitle2">
         <p> <span>@lang('lang.k_sayt')</span> <a href="#whatDo"><button><img src="/assets/images/arrowDown.png" alt=""></button></a></p>
      </div>
      <hr>
   ...
   <div class="whatDo" id="whatDo">
      ...
      <div class="cardConatiner">
         <!-- Card Conatiner--> 
         <a class="single-partition" href="#prices"><div class="card" data-aos="fade-up">
            ...
            <div class="card1">
               <div class=" card" data-aos="fade-up">
                  ...
                  <div class="subTitle ">
                     ...
                     <p class="subTitleee"><img  src="/assets/images/checkBox.svg" alt=""> <span>{{ $packf->content }}</span></p>
                     @endif
                     @endforeach
                     <p class="topTitle">@lang('lang.sayt_haz_m') {{ $packcont->day }} @lang('lang.gun')</p>
                     <hr>
                     <div class='cardPriceButton'> <div class='cardPriceC'><p class='cardPrice'> @lang('lang.qiymet') </p> {{ $packcont->price }} AZN </div>      </div>
                     <a class='wpContact' href='https://wa.me/994709836699'> <img src="/assets/images/wpblue.svg" width='25px' height='auto' alt="wp-icon">  @lang('lang.orderviawp')</a> 
                  </div>
               </div>
            </div> 
            @endif 
      ...
      <div class="aboutContainer">
         ...
         <div class="subAboutContainer">
            <div class="about1_1" data-aos="fade-up">
               <p><img  src="/assets/images/checkBox2.png" alt="@lang('lang.pesekar_k')"> @lang('lang.pesekar_k')</p>
            ...
            <div class="about2" data-aos="fade-up">
               <p><img  src="/assets/images/checkBox2.png" alt="@lang('lang.daimi_inkisaf')"> @lang('lang.daimi_inkisaf')</p>
               <p><img  src="/assets/images/checkBox2.png" alt="@lang('lang.gozlenti')"> @lang('lang.gozlenti')</p>
               <p><img  src="/assets/images/checkBox2.png" alt="@lang('lang.budce_kenar')"> @lang('lang.budce_kenar')</p>
            </div>
            <div class="about3" data-aos="fade-up">
               <p><img src="/assets/images/checkBox2.png" alt="@lang('lang.is_sev')"> @lang('lang.is_sev')</p>
               <p><img src="/assets/images/checkBox2.png" alt="@lang('lang.mesuliyyetli')"> @lang('lang.mesuliyyetli')</p>
            </div>
         </div>
      </div>
      <div class="text"  data-aos="fade-up">
   ...
   @include('front.widgets.message-map', ['class' => 'site-preparation'])
