...
function animationMenu()
{
    if (count === 0 ) {
        ...
        if(window.scrollY < 100)
        {
            ...
            document.getElementById('phoneNuber3').setAttribute("style" , "color:#225a93")
            document.getElementById('lang1').setAttribute("style" , "color:#225a93")
            document.getElementById('lang2').setAttribute("style" , "color:#225a93")
            document.getElementById('lang3').setAttribute("style" , "color:#225a93")
        ...
        document.getElementById('phoneNuber3').setAttribute("style" , "opacity:0;pointer-events:none;")
        document.getElementById('lang1').setAttribute("style" , "opacity:0;pointer-events:none;")
        document.getElementById('lang2').setAttribute("style" , "opacity:0;pointer-events:none;")
        document.getElementById('lang3').setAttribute("style" , "opacity:0;pointer-events:none;")
        ...
        document.getElementById('text1_4').setAttribute("style" , "opacity:1;transition:color 0.5s , opacity 0.5s 0.6s;pointer-events:all;");
        ...
        document.getElementById('ftextOverlaySpan1_3').setAttribute("style" , "opacity:1;transition: opacity 0.1s 0.7s;pointer-events:all;");

       document.getElementById('ftextOverlaySpan2').setAttribute("style" , "opacity:1;transition: opacity 0.1s 0.7s;pointer-events:all;");
    //    document.getElementById('menu-img').setAttribute("style" , "opacity:1;transition: opacity 0.1s 0.7s;pointer-events:all;");
   ...
   else
   {
       ...
       document.getElementById('text1_4').setAttribute("style" , "opacity:0;transition: opacity 0.5s 0.15s;pointer-events:none;");
       ...
       document.getElementById('ftextOverlaySpan1_3').setAttribute("style" , "opacity:0;transition: opacity 0.1s 0.1s;pointer-events:none;");
       document.getElementById('ftextOverlaySpan2').setAttribute("style" , "opacity:0;transition: opacity 0.1s 0.1s;pointer-events:none;");
    //    document.getElementById('menu-img').setAttribute("style" , "opacity:0;transition: opacity 0.1s 0.1s;pointer-events:none;");
       ...
       if(window.scrollY < 100)
        {
            ...
            document.getElementById('phoneNuber3').setAttribute("style" , "color:white;transition:1s;")
            document.getElementById('lang1').setAttribute("style" , "color:white;transition:1s;")
            document.getElementById('lang2').setAttribute("style" , "color:white;transition:1s;")
            document.getElementById('lang3').setAttribute("style" , "color:white;transition:1s;")
        ...
        if (window.scrollY > 100)
        {
            ...
            document.getElementById('phoneNuber3').setAttribute("style" , "color:#225a93;transition:1s;")
            document.getElementById('lang1').setAttribute("style" , "color:#225a93;transition:1s;")
            document.getElementById('lang2').setAttribute("style" , "color:#225a93;transition:1s;")
            document.getElementById('lang3').setAttribute("style" , "color:#225a93;transition:1s;")
...
window.addEventListener('scroll' , function () 
{
    ...
    else if (window.scrollY < 100 && count === 0)
    {
        ...
        document.getElementById('phoneNuber3').setAttribute("style" , "color:white")
        document.getElementById('lang1').setAttribute("style" , "color:white")
        document.getElementById('lang2').setAttribute("style" , "color:white")
        document.getElementById('lang3').setAttribute("style" , "color:white")
...
let button = $('.buttonContainer button');
